...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        $(window).on('load', function () {
            ...
            const date = new Date()
            document.getElementById('content-copy-right').innerHTML = `Developed by Andrew Bui © 2016 - ${date.getFullYear()}`
        });
        ...
        $('#my-address').gMap({
            ...
            markers: [
                {
                    address: "VANCOUVER",  /* You can change your address from here */
                    html: "<b>Address</b>: <br>Vancouver, British Columbia, Canada",   /* You can change display address text from here */
                    popup: true
                }
            ]
        });
